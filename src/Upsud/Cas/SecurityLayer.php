...
/**
 * The security layer is the absraction class to log in and log out users using the Upsud CAS.
 *
...
class SecurityLayer
{
     ...
     */
    public function __construct($version = '1.0', $host = 'sso.u-psud.fr', $port = 443, $path = '/cas/', $regenerateSession = false)
    {
        ...
        if (! $redirect) {
            ...
            if (! $redirect) {
                throw new \RuntimeException(
                    'Redirection URL automatic detection failed. You have to provide the redirection URL in '.__CLASS__.'::'.__METHOD__
                );
            }
        }
